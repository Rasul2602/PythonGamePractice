...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.rect.x = self.x
        self.rect.y = self.y
        self.fick = [self.game.character_spritesheet.get_sprite(97, 99, self.width, self.height),
        ...
        self.up_down_animations =[self.game.character_spritesheet.get_sprite(64, 227, self.width, self.height),
    ...
    def animate(self):
        ...
        if self.facing == "down":
            if self.y_change == 0:
                ...
                self.image = self.up_down_animations[math.floor(self.animation_loop)]
        ...
        if self.facing == "right":
            if self.y_change == 0:
                ...
                self.image = self.fick[math.floor(self.animation_loop)]
                self.animation_loop += 0.1
                if self.animation_loop >= 3:
                    self.animation_loop = 1  
        if self.facing == "left":
...
#         self.image = self.game.attacks.get_sprite(0, 0, self.width, self.height)
...
#         hits = pygame.sprite.spritecollide(self, self.game.enemies , True)
    ...
    #     right_animations = [self.game.attack.get_sprite(0, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(32, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(64, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(96, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(128, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(160, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(192, 0, self.width, self.height),
    #                         self.game.attack.get_sprite(224, 0, self.width, self.height)]
    ...
    #     left_animations = [self.game.attack.get_sprite(0, 0, self.width, self
    #     .height),
    #                         self.game.attack.get_sprite(32, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(64, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(96, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(128, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(160, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(192, 0, self.width, self
    #                         .height),
    #                         self.game.attack.get_sprite(224, 0, self.width, self
    #                         .height)]
